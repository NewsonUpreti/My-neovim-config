...
-- Map <Space>l to open the current HTML file in the default web browser
vim.api.nvim_set_keymap('n', '<Space>l', [[:!xdg-open %:p<CR>]], { noremap = true, silent = true })


-- Map <Space>f to execute :Format
vim.api.nvim_set_keymap('n', '<Space>f', ':Format<CR>', { noremap = true, silent = true })

-- Open file explorer with :Ex and close it with <Space>e
...
vim.api.nvim_exec([[
  autocmd TextChanged,TextChangedI *.html :silent! write
]], false)
...
vim.cmd[[
  augroup AutoSaveFiles
    ...
    autocmd BufWritePost *.py execute 'lcd ' .. fnameescape(expand('%:p:h')) | silent! write | lcd -
    autocmd BufWritePost *.js execute 'lcd ' .. fnameescape(expand('%:p:h')) | silent! write | lcd -
    autocmd BufWritePost *.css execute 'lcd ' .. fnameescape(expand('%:p:h')) | silent! write | lcd -
    autocmd BufWritePost *.html execute 'lcd ' .. fnameescape(expand('%:p:h')) | silent! write | lcd -
  augroup END
...
--setting shortcut for nvim tree
--
...
-- For NvimTreeToggle
vim.api.nvim_set_keymap('n', '<Space>er', ':NvimTreeRefresh<CR>', { noremap = true, silent = true })
